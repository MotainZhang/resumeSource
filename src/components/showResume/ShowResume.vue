            ...
            <section class="section-right">
                <div class="blog-box clearfloat">
                    <div class="blog">
                        ...
                        <div class="link github"><i class="icon-github-alt icon-1x"></i>Github: <a target="_blank" href="https://motainzhang.com/myResume/">{{resumeData.blogLink.github}}</a></div>
                        <div class="link personal-blog"><i class="icon-flag icon-1x"></i>技术博文 <a target="_blank" href="https://motainzhang.com">{{resumeData.blogLink.blog}}</a></div>
                    </div>
                </div>
